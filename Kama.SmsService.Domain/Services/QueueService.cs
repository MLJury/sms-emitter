...
namespace Kama.SmsService.Domain
{
    class QueueService : Service, svc.IQueueService
    {
        ...
        public AppCore.Result Enqueue(Library.Queue.Packet<Kama.SmsService.Core.Model.QueueItem> queuePacket)
        {
        ...
        public Library.Queue.ITransaction<Kama.SmsService.Core.Model.QueueItem> Dequeue(Library.Queue.Priority priority, TimeSpan timeSpan)
        {
